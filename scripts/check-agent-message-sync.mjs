...
requireText('.codex-plugin/plugin.json', [
  '"name": "memesh"', '"version"', '"mcpServers": "./.codex-plugin/mcp.json"',
]);
requireText('.codex-plugin/mcp.json', [
  '"mcpServers"', '"memesh"', '"command": "node"',
  '"args": ["./dist/mcp/server.js"]', '"cwd": "."',
]);
